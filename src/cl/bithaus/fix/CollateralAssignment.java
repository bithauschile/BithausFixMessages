...
public class CollateralAssignment extends FixBaseMessage {
    ...
    public CollateralAssignment.NoExecs getNoExecs() {
        return this.noExecs;
    }

    public void setNoExecs(CollateralAssignment.NoExecs noExecs) {
        this.noExecs = noExecs;
    }
    public CollateralAssignment.NoTrades getNoTrades() {
        return this.noTrades;
    }

    public void setNoTrades(CollateralAssignment.NoTrades noTrades) {
        this.noTrades = noTrades;
    }
    public CollateralAssignment.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(CollateralAssignment.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
    public CollateralAssignment.NoMiscFees getNoMiscFees() {
        return this.noMiscFees;
    }

    public void setNoMiscFees(CollateralAssignment.NoMiscFees noMiscFees) {
        this.noMiscFees = noMiscFees;
    }
        

    public static class NoExecs extends FixGroup<CollateralAssignment.NoExecs.NoExecsEntry> {
    ...
    public static class NoTrades extends FixGroup<CollateralAssignment.NoTrades.NoTradesEntry> {
    ...
    public static class NoUnderlyings extends FixGroup<CollateralAssignment.NoUnderlyings.NoUnderlyingsEntry> {
    ...
    public static class NoMiscFees extends FixGroup<CollateralAssignment.NoMiscFees.NoMiscFeesEntry> {
