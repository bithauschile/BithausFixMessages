...
public class AllocationReport extends FixBaseMessage {
    ...
    public AllocationReport() { 
        super("AS", MsgCategory.APP);
    }

    public String getAllocReportID() {
        return this.allocReportID;
    }           
    ...
    public Integer getAllocReportType() {
        return this.allocReportType;
    }           

    public void setAllocReportType(Integer allocReportType) {
    ...
    public AllocationReport.NoOrders getNoOrders() {
        return this.noOrders;
    }

    public void setNoOrders(AllocationReport.NoOrders noOrders) {
        this.noOrders = noOrders;
    }
    public AllocationReport.NoExecs getNoExecs() {
        return this.noExecs;
    }

    public void setNoExecs(AllocationReport.NoExecs noExecs) {
        this.noExecs = noExecs;
    }
    public AllocationReport.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(AllocationReport.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
    public AllocationReport.NoLegs getNoLegs() {
        return this.noLegs;
    }

    public void setNoLegs(AllocationReport.NoLegs noLegs) {
        this.noLegs = noLegs;
    }
    public AllocationReport.NoAllocs getNoAllocs() {
        return this.noAllocs;
    }

    public void setNoAllocs(AllocationReport.NoAllocs noAllocs) {
        this.noAllocs = noAllocs;
    }
        

    public static class NoOrders extends FixGroup<AllocationReport.NoOrders.NoOrdersEntry> {
    ...
    public static class NoExecs extends FixGroup<AllocationReport.NoExecs.NoExecsEntry> {
    ...
    public static class NoUnderlyings extends FixGroup<AllocationReport.NoUnderlyings.NoUnderlyingsEntry> {
    ...
    public static class NoLegs extends FixGroup<AllocationReport.NoLegs.NoLegsEntry> {
    ...
    public static class NoAllocs extends FixGroup<AllocationReport.NoAllocs.NoAllocsEntry> {
