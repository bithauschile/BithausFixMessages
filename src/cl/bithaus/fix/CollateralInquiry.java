 ...
 */
public class CollateralInquiry extends FixBaseMessage {
    ...
    public CollateralInquiry.NoCollInquiryQualifier getNoCollInquiryQualifier() {
        return this.noCollInquiryQualifier;
    }

    public void setNoCollInquiryQualifier(CollateralInquiry.NoCollInquiryQualifier noCollInquiryQualifier) {
        this.noCollInquiryQualifier = noCollInquiryQualifier;
    }
    public CollateralInquiry.NoExecs getNoExecs() {
        return this.noExecs;
    }

    public void setNoExecs(CollateralInquiry.NoExecs noExecs) {
        this.noExecs = noExecs;
    }
    public CollateralInquiry.NoTrades getNoTrades() {
        return this.noTrades;
    }

    public void setNoTrades(CollateralInquiry.NoTrades noTrades) {
        this.noTrades = noTrades;
    }
    public CollateralInquiry.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(CollateralInquiry.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
        

    public static class NoCollInquiryQualifier extends FixGroup<CollateralInquiry.NoCollInquiryQualifier.NoCollInquiryQualifierEntry> {
    ...
    public static class NoExecs extends FixGroup<CollateralInquiry.NoExecs.NoExecsEntry> {
    ...
    public static class NoTrades extends FixGroup<CollateralInquiry.NoTrades.NoTradesEntry> {
    ...
    public static class NoUnderlyings extends FixGroup<CollateralInquiry.NoUnderlyings.NoUnderlyingsEntry> {
