 ...
 */
public class AllocationReportAck extends FixBaseMessage {
    ...
    public AllocationReportAck.NoAllocs getNoAllocs() {
        return this.noAllocs;
    }

    public void setNoAllocs(AllocationReportAck.NoAllocs noAllocs) {
        this.noAllocs = noAllocs;
    }
        

    public static class NoAllocs extends FixGroup<AllocationReportAck.NoAllocs.NoAllocsEntry> {
