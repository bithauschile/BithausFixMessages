 ...
 */
public class NewOrderMultileg extends FixBaseMessage {
    ...
    public NewOrderMultileg.NoAllocs getNoAllocs() {
        return this.noAllocs;
    }

    public void setNoAllocs(NewOrderMultileg.NoAllocs noAllocs) {
        this.noAllocs = noAllocs;
    }
    public NewOrderMultileg.NoTradingSessions getNoTradingSessions() {
        return this.noTradingSessions;
    }

    public void setNoTradingSessions(NewOrderMultileg.NoTradingSessions noTradingSessions) {
        this.noTradingSessions = noTradingSessions;
    }
    public NewOrderMultileg.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(NewOrderMultileg.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
    public NewOrderMultileg.NoLegs getNoLegs() {
        return this.noLegs;
    }

    public void setNoLegs(NewOrderMultileg.NoLegs noLegs) {
        this.noLegs = noLegs;
    }
        

    public static class NoAllocs extends FixGroup<NewOrderMultileg.NoAllocs.NoAllocsEntry> {
    ...
    public static class NoTradingSessions extends FixGroup<NewOrderMultileg.NoTradingSessions.NoTradingSessionsEntry> {
    ...
    public static class NoUnderlyings extends FixGroup<NewOrderMultileg.NoUnderlyings.NoUnderlyingsEntry> {
    ...
    public static class NoLegs extends FixGroup<NewOrderMultileg.NoLegs.NoLegsEntry> {
