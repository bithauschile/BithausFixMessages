 ...
 */
public class MarketDataIncrementalRefresh extends FixBaseMessage {
    ...
    public MarketDataIncrementalRefresh.NoMDEntries getNoMDEntries() {
        return this.noMDEntries;
    }

    public void setNoMDEntries(MarketDataIncrementalRefresh.NoMDEntries noMDEntries) {
        this.noMDEntries = noMDEntries;
    }
        

    public static class NoMDEntries extends FixGroup<MarketDataIncrementalRefresh.NoMDEntries.NoMDEntriesEntry> {
