 ...
 */
public class QuoteStatusReport extends FixBaseMessage {
    ...
    public QuoteStatusReport.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(QuoteStatusReport.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
    public QuoteStatusReport.NoLegs getNoLegs() {
        return this.noLegs;
    }

    public void setNoLegs(QuoteStatusReport.NoLegs noLegs) {
        this.noLegs = noLegs;
    }
    public QuoteStatusReport.NoQuoteQualifiers getNoQuoteQualifiers() {
        return this.noQuoteQualifiers;
    }

    public void setNoQuoteQualifiers(QuoteStatusReport.NoQuoteQualifiers noQuoteQualifiers) {
        this.noQuoteQualifiers = noQuoteQualifiers;
    }
        

    public static class NoUnderlyings extends FixGroup<QuoteStatusReport.NoUnderlyings.NoUnderlyingsEntry> {
    ...
    public static class NoLegs extends FixGroup<QuoteStatusReport.NoLegs.NoLegsEntry> {
    ...
    public static class NoQuoteQualifiers extends FixGroup<QuoteStatusReport.NoQuoteQualifiers.NoQuoteQualifiersEntry> {
