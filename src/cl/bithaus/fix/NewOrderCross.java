 ...
 */
public class NewOrderCross extends FixBaseMessage {
    ...
    public NewOrderCross.NoSides getNoSides() {
        return this.noSides;
    }

    public void setNoSides(NewOrderCross.NoSides noSides) {
        this.noSides = noSides;
    }
    public NewOrderCross.NoUnderlyings getNoUnderlyings() {
        return this.noUnderlyings;
    }

    public void setNoUnderlyings(NewOrderCross.NoUnderlyings noUnderlyings) {
        this.noUnderlyings = noUnderlyings;
    }
    public NewOrderCross.NoLegs getNoLegs() {
        return this.noLegs;
    }

    public void setNoLegs(NewOrderCross.NoLegs noLegs) {
        this.noLegs = noLegs;
    }
        

    public static class NoSides extends FixGroup<NewOrderCross.NoSides.NoSidesEntry> {
    ...
    public static class NoUnderlyings extends FixGroup<NewOrderCross.NoUnderlyings.NoUnderlyingsEntry> {
    ...
    public static class NoLegs extends FixGroup<NewOrderCross.NoLegs.NoLegsEntry> {
